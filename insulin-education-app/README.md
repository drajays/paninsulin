...
- 13 learning modules and all **278 patient Q&As** from `insulin_education_module.md`
- Detailed training notes for every module
- Image-based visual questions with accessible inline SVG illustrations
- 44 MCQs with instant feedback and explanations
...
- `src/data.js` — 13 modules (tagged `core`/related), 278 Q&As including Indian and US insulin brand names, training notes and source links
